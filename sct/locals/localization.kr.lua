...
SCT.LOCALS.FiveCPMessage = "마무리!"; -- Message to be displayed when you have 5 combo points
...
SCT.LOCALS.FONTS = { 
	...
	[5] = { name="ARIALN", path="Fonts\\ARIALN.ttf"},
	[6] = { name="ARIALN2", path="Fonts\\ARIALN.ttf"},
}
