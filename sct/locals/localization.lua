...
SCT.LOCALS.KillingBlow = "Killing Blow!"; -- Message to be displayed when you kill something
SCT.LOCALS.Interrupted = "Interrupted!"; -- Message to be displayed when you are interrupted
SCT.LOCALS.Dispel = "Removed!"; -- Message to be displayed when you dispel
SCT.LOCALS.DispelFailed = "Dispel Failed!"; -- Message to be displayed when your dispel failed
...
SCT.LOCALS.DEATHKNIGHT = "Death Knight";
