...
SCT.LOCALS.OPTION_EVENT24 = {name = "Unterbrochen", tooltipText = "Aktivier die Anzeige wenn du unterbrochen wirst"};
...
SCT.LOCALS.OPTION_CHECK12 = { name = "Zauberfarben", tooltipText = "Aktiviert/Deaktiviert das Anzeigen des Zauberschadens in Farbe der entsprechenden Klasse (Farben sind NICHT einstellbar)"};
