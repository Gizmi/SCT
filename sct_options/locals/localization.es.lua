...
SCT.LOCALS.OPTION_CHECK9 = { name = "Modo Independiente de los FPS", tooltipText = "Determina si la velocidad de animaci\195\179n usa tus FPS o no. Cuando est\195\161 activado hace las animaciones m\195\161s consistentes y aumenta enormemente la velocidad en m\195\161quinas lentas o en situaciones con mucho lag"};
...
SCT.LOCALS.OPTION_CHECK12 = { name = "Colores de Hechizo", tooltipText = "Muestra el da\195\177o de hechizos en colores dependiendo de la clase del hechizo (los colores no son configurables)"};
