...
SCT.LOCALS.OPTION_SLIDER13 = { name="Фильтр исциления", minText="0", maxText="10000", tooltipText = "Настройка минимального значения исциления, привышая которое оно будет выводиться в SCT. Отличная фильтрация повторяющихся мелких исцилений таких как: Тотемы, Благословения, и т.д..."};
SCT.LOCALS.OPTION_SLIDER14 = { name="Фильтр маны", minText="0", maxText="10000", tooltipText = "Настройка минимального значения получаемой энергии, привышая которое оно будет выводиться в SCT. Отличная фильтрация повторяющихся, мелких порций получаемой энергии таких как Тотемы, Благословения, и т.д..."};
...
SCT.LOCALS.OPTION_SLIDER17 = { name="Фильтр урона", minText="0", maxText="10000", tooltipText = "Настройка минимального значения урона, привышая которое оно будет выводиться в SCT. Отличная фильтрация повторяющихся мелких ударов таких как: Ранящих щитов, Мелких ДОТов, и т.д..."};
...
SCT.LOCALS.OPTION_SELECTION8 = { name="Сокрощение типа способностей", tooltipText = "Как сокрощать названия заклинаний.", table = {[1] = "Урезывать", [2] = "Сокращать"}};
