...
SCT.LOCALS.OPTION_EDITBOX5 = { name="Звуковой файл", tooltipText = "Путь к звуковому файлу формата .wave .ogg для данного события. Пример. Interface\\AddOns\\MyAddOn\\mysound.wav или Sound\\Spells\\ShaysBell.ogg"};
