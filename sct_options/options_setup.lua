...
SCT.OPTIONS.FrameEventFrames [SCT.LOCALS.OPTION_EVENT23.name] = { index = 23, tooltipText = SCT.LOCALS.OPTION_EVENT23.tooltipText, SCTVar = "SHOWKILLBLOW"};
SCT.OPTIONS.FrameEventFrames [SCT.LOCALS.OPTION_EVENT24.name] = { index = 24, tooltipText = SCT.LOCALS.OPTION_EVENT24.tooltipText, SCTVar = "SHOWINTERRUPT"};
SCT.OPTIONS.FrameEventFrames [SCT.LOCALS.OPTION_EVENT25.name] = { index = 25, tooltipText = SCT.LOCALS.OPTION_EVENT25.tooltipText, SCTVar = "SHOWDISPEL"};
SCT.OPTIONS.FrameEventFrames [SCT.LOCALS.OPTION_EVENT26.name] = { index = 26, tooltipText = SCT.LOCALS.OPTION_EVENT26.tooltipText, SCTVar = "SHOWRUNES"};
...
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK14.name] = { index = 14, tooltipText = SCT.LOCALS.OPTION_CHECK14.tooltipText, SCTVar = "SKILLNAME"};
...
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK16.name] = { index = 16, tooltipText = SCT.LOCALS.OPTION_CHECK16.tooltipText, SCTVar = "SHOWGLANCE"};
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK17.name] = { index = 17, tooltipText = SCT.LOCALS.OPTION_CHECK17.tooltipText, SCTVar = "SHOWHOTS"};
...
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK19.name] = { index = 19, tooltipText = SCT.LOCALS.OPTION_CHECK19.tooltipText, SCTVar = "WOWHEAL"};
...
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK21.name] = { index = 21, tooltipText = SCT.LOCALS.OPTION_CHECK21.tooltipText};
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK22.name] = { index = 22, tooltipText = SCT.LOCALS.OPTION_CHECK22.tooltipText};
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK23.name] = { index = 23, tooltipText = SCT.LOCALS.OPTION_CHECK23.tooltipText};
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK24.name] = { index = 24, tooltipText = SCT.LOCALS.OPTION_CHECK24.tooltipText};
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK25.name] = { index = 25, tooltipText = SCT.LOCALS.OPTION_CHECK25.tooltipText};
SCT.OPTIONS.FrameCheckButtons [SCT.LOCALS.OPTION_CHECK26.name] = { index = 26, tooltipText = SCT.LOCALS.OPTION_CHECK26.tooltipText};
...
SCT.OPTIONS.FrameSliders [SCT.LOCALS.OPTION_SLIDER2.name] = { index = 2, SCTVar = "TEXTSIZE", minValue = 8, maxValue = 32, valueStep = 1, minText=SCT.LOCALS.OPTION_SLIDER2.minText, maxText=SCT.LOCALS.OPTION_SLIDER2.maxText, tooltipText = SCT.LOCALS.OPTION_SLIDER2.tooltipText, SCTTable = SCT.FRAME1};
SCT.OPTIONS.FrameSliders [SCT.LOCALS.OPTION_SLIDER3.name] = { index = 3, SCTVar = "LOWHP", minValue = 10, maxValue = 90, valueStep = 5, minText=SCT.LOCALS.OPTION_SLIDER3.minText, maxText=SCT.LOCALS.OPTION_SLIDER3.maxText, tooltipText = SCT.LOCALS.OPTION_SLIDER3.tooltipText};
SCT.OPTIONS.FrameSliders [SCT.LOCALS.OPTION_SLIDER4.name] = { index = 4, SCTVar = "LOWMANA", minValue = 10, maxValue = 90, valueStep = 5, minText=SCT.LOCALS.OPTION_SLIDER4.minText, maxText=SCT.LOCALS.OPTION_SLIDER4.maxText, tooltipText = SCT.LOCALS.OPTION_SLIDER4.tooltipText};
...
--Color options
SCT.OPTIONS.FrameColors = { };
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR1.name] = { index = 1, tooltipText = SCT.LOCALS.OPTION_COLOR1.tooltipText, SCTVar = SPELL_SCHOOL0_CAP};
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR2.name] = { index = 2, tooltipText = SCT.LOCALS.OPTION_COLOR2.tooltipText, SCTVar = SPELL_SCHOOL1_CAP};
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR3.name] = { index = 3, tooltipText = SCT.LOCALS.OPTION_COLOR3.tooltipText, SCTVar = SPELL_SCHOOL2_CAP};
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR4.name] = { index = 4, tooltipText = SCT.LOCALS.OPTION_COLOR4.tooltipText, SCTVar = SPELL_SCHOOL3_CAP};
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR5.name] = { index = 5, tooltipText = SCT.LOCALS.OPTION_COLOR5.tooltipText, SCTVar = SPELL_SCHOOL4_CAP};
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR6.name] = { index = 6, tooltipText = SCT.LOCALS.OPTION_COLOR6.tooltipText, SCTVar = SPELL_SCHOOL5_CAP};
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR7.name] = { index = 7, tooltipText = SCT.LOCALS.OPTION_COLOR7.tooltipText, SCTVar = SPELL_SCHOOL6_CAP};
SCT.OPTIONS.FrameColors [SCT.LOCALS.OPTION_COLOR8.name] = { index = 8, tooltipText = SCT.LOCALS.OPTION_COLOR8.tooltipText};
...
SCT.OPTIONS.FrameSelections [SCT.LOCALS.OPTION_SELECTION3.name] = { index = 3, SCTVar = "FONT", SCTValueSave=1, tooltipText = SCT.LOCALS.OPTION_SELECTION3.tooltipText, table = SCT.LOCALS.OPTION_SELECTION3.table, SCTTable = SCT.FRAME1};
...
SCT.OPTIONS.FrameSelections [SCT.LOCALS.OPTION_SELECTION5.name] = { index = 5, SCTVar = "MSGFONT", SCTValueSave=1, tooltipText = SCT.LOCALS.OPTION_SELECTION5.tooltipText, table = SCT.LOCALS.OPTION_SELECTION5.table, SCTTable = SCT.MSG};
...
SCT.OPTIONS.FrameSelections [SCT.LOCALS.OPTION_SELECTION7.name] = { index = 7, SCTVar = "ALIGN", tooltipText = SCT.LOCALS.OPTION_SELECTION7.tooltipText, table = SCT.LOCALS.OPTION_SELECTION7.table, SCTTable = SCT.FRAME1};
SCT.OPTIONS.FrameSelections [SCT.LOCALS.OPTION_SELECTION8.name] = { index = 8, SCTVar = "TRUNCATETYPE", tooltipText = SCT.LOCALS.OPTION_SELECTION8.tooltipText, table = SCT.LOCALS.OPTION_SELECTION8.table};
SCT.OPTIONS.FrameSelections [SCT.LOCALS.OPTION_SELECTION9.name] = { index = 9, SCTVar = "ICONSIDE", tooltipText = SCT.LOCALS.OPTION_SELECTION9.tooltipText, table = SCT.LOCALS.OPTION_SELECTION9.table, SCTTable = SCT.FRAME1};

--Custom Selection Boxes
SCT.OPTIONS.FrameCustomSelections = {};
SCT.OPTIONS.FrameCustomSelections [SCT.LOCALS.OPTION_CUSTOMSELECTION1.name] = { index = 1, tooltipText = SCT.LOCALS.OPTION_CUSTOMSELECTION1.tooltipText, table = SCT.LOCALS.OPTION_CUSTOMSELECTION1.table};
SCT.OPTIONS.FrameCustomSelections [SCT.LOCALS.OPTION_CUSTOMSELECTION2.name] = { index = 2, tooltipText = SCT.LOCALS.OPTION_CUSTOMSELECTION2.tooltipText, table = SCT.LOCALS.OPTION_CUSTOMSELECTION2.table};
SCT.OPTIONS.FrameCustomSelections [SCT.LOCALS.OPTION_CUSTOMSELECTION3.name] = { index = 3, tooltipText = SCT.LOCALS.OPTION_CUSTOMSELECTION3.tooltipText, table = SCT.LOCALS.OPTION_CUSTOMSELECTION3.table};
SCT.OPTIONS.FrameCustomSelections [SCT.LOCALS.OPTION_CUSTOMSELECTION4.name] = { index = 4, tooltipText = SCT.LOCALS.OPTION_CUSTOMSELECTION4.tooltipText, table = SCT.LOCALS.OPTION_CUSTOMSELECTION4.table};
SCT.OPTIONS.FrameCustomSelections [SCT.LOCALS.OPTION_CUSTOMSELECTION5.name] = { index = 5, tooltipText = SCT.LOCALS.OPTION_CUSTOMSELECTION5.tooltipText, table = SCT.LOCALS.OPTION_CUSTOMSELECTION5.table};
SCT.OPTIONS.FrameCustomSelections [SCT.LOCALS.OPTION_CUSTOMSELECTION6.name] = { index = 6, tooltipText = SCT.LOCALS.OPTION_CUSTOMSELECTION6.tooltipText, table = SCT.LOCALS.OPTION_CUSTOMSELECTION6.table};
...
SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC21.name] = {index = 21, tooltipText = SCT.LOCALS.OPTION_MISC21.tooltipText}
...
SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC28.name] = {index = 28, tooltipText = SCT.LOCALS.OPTION_MISC28.tooltipText}
SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC29.name] = {index = 29, tooltipText = SCT.LOCALS.OPTION_MISC29.tooltipText}
SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC30.name] = {index = 30, tooltipText = SCT.LOCALS.OPTION_MISC30.tooltipText}
SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC31.name] = {index = 31, tooltipText = SCT.LOCALS.OPTION_MISC31.tooltipText}
SCT.OPTIONS.FrameMisc [SCT.LOCALS.OPTION_MISC32.name] = {index = 32, tooltipText = SCT.LOCALS.OPTION_MISC32.tooltipText}
...
SCT.OPTIONS.EditBoxes [SCT.LOCALS.OPTION_EDITBOX1.name] = { index = 1, tooltipText = SCT.LOCALS.OPTION_EDITBOX1.tooltipText};
SCT.OPTIONS.EditBoxes [SCT.LOCALS.OPTION_EDITBOX2.name] = { index = 2, tooltipText = SCT.LOCALS.OPTION_EDITBOX2.tooltipText};
SCT.OPTIONS.EditBoxes [SCT.LOCALS.OPTION_EDITBOX3.name] = { index = 3, tooltipText = SCT.LOCALS.OPTION_EDITBOX3.tooltipText};
SCT.OPTIONS.EditBoxes [SCT.LOCALS.OPTION_EDITBOX4.name] = { index = 4, tooltipText = SCT.LOCALS.OPTION_EDITBOX4.tooltipText};
SCT.OPTIONS.EditBoxes [SCT.LOCALS.OPTION_EDITBOX5.name] = { index = 5, tooltipText = SCT.LOCALS.OPTION_EDITBOX5.tooltipText};
